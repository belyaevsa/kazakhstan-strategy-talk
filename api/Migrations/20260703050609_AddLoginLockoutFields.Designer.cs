...
namespace KazakhstanStrategyApi.Migrations
{
    ...
    [Migration("20260703050609_AddLoginLockoutFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KazakhstanStrategyApi.Models.ContentReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ReporterProfileId", "ContentType", "ContentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("KazakhstanStrategyApi.Models.ContentReport", b =>
                {
                    b.HasOne("KazakhstanStrategyApi.Models.Profile", "ReporterProfile")
                        .WithMany()
                        .HasForeignKey("ReporterProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KazakhstanStrategyApi.Models.Profile", "ReviewedByProfile")
                        .WithMany()
